...
_SUMTYPE = _descriptor.Descriptor(
  name='SumType',
  full_name='flyteidl.core.SumType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='summands', full_name='flyteidl.core.SumType.summands', index=0,
...
_RECORDTYPE_RECORDFIELD = _descriptor.Descriptor(
  name='RecordField',
  full_name='flyteidl.core.RecordType.RecordField',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='flyteidl.core.RecordType.RecordField.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='flyteidl.core.RecordType.RecordField.type', index=1,
...
_RECORDTYPE = _descriptor.Descriptor(
  name='RecordType',
  full_name='flyteidl.core.RecordType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fields', full_name='flyteidl.core.RecordType.fields', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_RECORDTYPE_RECORDFIELD, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_LITERALTYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sum', full_name='flyteidl.core.LiteralType.sum', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='record', full_name='flyteidl.core.LiteralType.record', index=7,
...
_SUMTYPE.fields_by_name['summands'].message_type = _LITERALTYPE
_RECORDTYPE_RECORDFIELD.fields_by_name['type'].message_type = _LITERALTYPE
_RECORDTYPE_RECORDFIELD.containing_type = _RECORDTYPE
_RECORDTYPE.fields_by_name['fields'].message_type = _RECORDTYPE_RECORDFIELD
...
_LITERALTYPE.fields_by_name['sum'].message_type = _SUMTYPE
_LITERALTYPE.fields_by_name['record'].message_type = _RECORDTYPE
...
_LITERALTYPE.oneofs_by_name['type'].fields.append(
  _LITERALTYPE.fields_by_name['sum'])
_LITERALTYPE.fields_by_name['sum'].containing_oneof = _LITERALTYPE.oneofs_by_name['type']
_LITERALTYPE.oneofs_by_name['type'].fields.append(
  _LITERALTYPE.fields_by_name['record'])
_LITERALTYPE.fields_by_name['record'].containing_oneof = _LITERALTYPE.oneofs_by_name['type']
...
DESCRIPTOR.message_types_by_name['SumType'] = _SUMTYPE
...
SumType = _reflection.GeneratedProtocolMessageType('SumType', (_message.Message,), dict(
  DESCRIPTOR = _SUMTYPE,
  __module__ = 'flyteidl.core.types_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.SumType)
  ))
_sym_db.RegisterMessage(SumType)
...
RecordType = _reflection.GeneratedProtocolMessageType('RecordType', (_message.Message,), dict(
  ...
  RecordField = _reflection.GeneratedProtocolMessageType('RecordField', (_message.Message,), dict(
    DESCRIPTOR = _RECORDTYPE_RECORDFIELD,
    __module__ = 'flyteidl.core.types_pb2'
    # @@protoc_insertion_point(class_scope:flyteidl.core.RecordType.RecordField)
    ))
  ,
  DESCRIPTOR = _RECORDTYPE,
  __module__ = 'flyteidl.core.types_pb2'
  # @@protoc_insertion_point(class_scope:flyteidl.core.RecordType)
  ))
_sym_db.RegisterMessage(RecordType)
_sym_db.RegisterMessage(RecordType.RecordField)
